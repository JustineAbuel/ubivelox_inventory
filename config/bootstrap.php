 ...
 */
//date_default_timezone_set(Configure::read('App.defaultTimezone')); //03-15-2022-pao
date_default_timezone_set('Asia/Manila'); //03-15-2022-pao
ini_set('date.timezone', 'Asia/Manila'); //03-15-2022-pao
