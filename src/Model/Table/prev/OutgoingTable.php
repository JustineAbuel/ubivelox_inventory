 ...
 * Outgoing Model
 *
 * @property \App\Model\Table\TransactionItemsTable&\Cake\ORM\Association\BelongsTo $TransactionItems
 *
...
class OutgoingTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsTo('TransactionItems', [
            'foreignKey' => 'transaction_items_id',
            'joinType' => 'INNER',
        ]);
    }
    ...
    {
        $rules->add($rules->existsIn('transaction_items_id', 'TransactionItems'), ['errorField' => 'transaction_items_id']);
