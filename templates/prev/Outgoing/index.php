        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('transaction_items_id') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $outgoing->has('transaction_item') ? $this->Html->link($outgoing->transaction_item->id, ['controller' => 'TransactionItems', 'action' => 'view', $outgoing->transaction_item->id]) : '' ?></td>
