  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Upload CSV Data (Categories)</h5>
            ...
            <div class="card">
              <div class="card-header     "> 
                  ...
                  <?= $this->Html->link(__('New Category'), ['action' => 'add'], ['class' => 'button float-right btn btn-primary float-right  ']) ?>
                    <?= $this->Html->link(
                      "<font color='white' size='3px'><i class='fa fa-file-excel'></i></font> Mass upload Category", 
                      ['action' => 'uploadcsv'], 
                ...
                <table id="example1" class="table table-bordered table-striped table hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= h(date('Y-m-d H:i:s', strtotime($category->date_added))) ?></td>
