 ...
 * @var \App\Model\Entity\TransactionType[]|\Cake\Collection\CollectionInterface $transactionType
 */
?>
<div class="transactionType index content">
    <?= $this->Html->link(__('New Transaction Type'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Transaction Type') ?></h3>
