...
<?= $this->Html->script('plugins/jszip/jszip.min.js'); ?>
<?= $this->Html->script('plugins/pdfmake/pdfmake.min'); ?>
<?= $this->Html->script('plugins/pdfmake/vfs_fonts.js'); ?>
...
<?php //echo $this->fetch('content'); ?> <!-- this is important for displaying user interface -->